-- Include facility timezone in the authoritative availability read model so the
-- booking screen does not need a second pitches query for metadata the RPC
-- already loaded to generate slots.
begin;
