...
-- Apply after 022_hosted_lint_repairs.sql.
-- Guest Help stays available without authentication, but anonymous creation
-- must cross the trusted server boundary. Raw client IPs are never stored.
