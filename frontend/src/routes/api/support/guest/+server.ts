...
function clientIp(request: Request): string | null {
  // Vercel overwrites x-forwarded-for instead of trusting a caller-supplied
  // value. In local/non-Vercel environments this endpoint fails closed if no
  // trusted network identity is available.
