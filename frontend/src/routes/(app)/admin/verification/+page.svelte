...
{#if selected}
  <div class="fixed inset-0 z-50 flex items-end bg-black/55 backdrop-blur-[2px] sm:items-center sm:justify-center sm:p-4" role="presentation">
    <button type="button" tabindex="-1" aria-label="Close verification review" class="absolute inset-0 cursor-default" disabled={!!reviewingId} on:click={() => selected=null}></button>
    <section class="uneem-mobile-sheet relative z-10 max-h-[92vh] overflow-y-auto sm:max-w-2xl" role="dialog" aria-modal="true" tabindex="-1">
