<script lang="ts">
  ...
  $: copy = ar ? {
    title:'المستخدمون', subtitle:'حسابات الطلبة وحالتها.', search:'بحث بالاسم أو اسم المستخدم أو رقم الطالب', searchAction:'بحث', all:'الكل', active:'نشط', pending:'قيد المراجعة', suspended:'موقوف',
    academic:'بريد جامعي', personal:'بريد شخصي', verified:'موثّق', required:'مطلوب', reviewing:'قيد المراجعة', rejected:'يحتاج تصحيح', conflict:'تعارض', admin:'مشرف', empty:'لا يوجد مستخدمون', loadError:'تعذر تحميل المستخدمين.', verification:'طلبات التحقق', previous:'السابق', next:'التالي', users:'مستخدم',
    suspend:'إيقاف الوصول', restore:'استعادة الوصول', suspendTitle:'إيقاف الوصول الرياضي؟', restoreTitle:'استعادة الوصول الرياضي؟', suspendBody:'سيتم منع هذا الطالب من استخدام مسارات الرياضة. الحجوزات الحالية لا تُلغى تلقائياً.', restoreBody:'سيعود الوصول بعد التحقق من شروط الحساب. العملية ستُسجل في سجل الإدارة.', reason:'السبب', cancel:'إلغاء', confirmSuspend:'إيقاف الوصول', confirmRestore:'استعادة الوصول', saving:'جارٍ الحفظ…', updated:'تم تحديث وصول المستخدم', updateError:'تعذر تحديث وصول المستخدم.',
    conduct:'سلوك مخالف', safety:'سلامة', spam:'رسائل مزعجة أو إساءة استخدام', fakeIdentity:'هوية مشكوك فيها', bookingAbuse:'إساءة استخدام الحجز', matchAbuse:'إساءة استخدام المباريات', other:'سبب آخر', reviewComplete:'اكتملت المراجعة', appealApproved:'تم قبول طلب المراجعة'
  } : {
