...
{#if cancelSlot}
  <div class="fixed inset-0 z-50 flex items-end bg-black/55 backdrop-blur-[2px] sm:items-center sm:justify-center sm:p-4" role="presentation" tabindex="-1" on:keydown={() => {}} on:click={() => !canceling && (cancelSlot=null)}>
    <section class="uneem-mobile-sheet sm:max-w-md" role="dialog" aria-modal="true" tabindex="-1" on:click|stopPropagation on:keydown|stopPropagation>
